...
## Dig­i­tal Tools for Cre­ative Col­lab­o­ra­tion, EKA's workshop, 25-29 October 2021, Tallinn (EE)

![img_8701.jpg](img/img_8701.jpg)
<figcaption>First DTCC workshop at EKA in Tallinn</figcaption>
...
was documented by EKA in an other publication, here, we intend to
...
The best and the worst situation:
...
There is a strong connection between emotional bonds and creativity. The group is creating a social link about the rituals (individual, or
...
stories. They have also completed the prototyping phase and will further develop the visualization.
...
how it will create meaning, and how it can be inclusive. 

They have designed a system that is free from hierarchy.
...
<figcaption><i>Emotional bonds</i> first sketches</figcaption>
...
group explored potential issues with delays and is focused on creating a fun and creative atmosphere while using this tool. They are also
...
This tool is not to be utilized by professional musicians since it might not fully meet their requirements or expectations. However, musicians
...
<figcaption><i>Motivation and creativity</i> first sketches and moodboard</figcaption>
...
<figcaption><i>Social behaviour</i> presentation</figcaption>
...
- Who should be in charge to program the buddy: a friend, a colleague, or a psychologist?
- How to prevent an addiction towards the Buddy while allowing the users continue to listen to themselves?

Since this data can be used in both ways, it can empower both parties.
...
<figcaption><i>Work/life balance</i> buddy paper model</figcaption>
